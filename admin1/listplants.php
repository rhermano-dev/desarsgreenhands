                                ...
                                <table class="table table-borderless table-striped table-data3 ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Price of Plants</th>
                                            <th>Type of Plants</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <?php
                                                ...
                                                $query_plants = "SELECT * FROM `plants_info`";
                                            ...
                                            <td><?echo $rows_plants['price_of_plant'];?></td>
                                            <td><?echo $rows_plants['type_of_plant'];?></td>
                                            <td><?echo $rows_plants['description_of_plant'];?></td>
                                            <td>
